...
public class PrincipalVuelos extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PrincipalVuelos frame = new PrincipalVuelos(null, null, null, null);
	...
	public PrincipalVuelos(Controller controller, String origen, String destino, Date objDate) throws RemoteException {
