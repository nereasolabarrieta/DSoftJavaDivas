...
public class RestClient_Unmarshalling extends RestClient {
	...
	public void makeGetRequest(String resource_URL) throws Exception {
		...
		if (request_OK(response.getStatus())) {
			...
			// From wikipedia "marshalling is the process of transforming the
			// memory representation of an object to a data format suitable for
	...
	public void print_with_unmarshalling(Response response) {
		// this method prints the result obtained from the resource directly as
		// a JSON string
		// todo
