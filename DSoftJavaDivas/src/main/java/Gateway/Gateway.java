...
public class Gateway {
	...
	public void crearConexion() {
		// RestClient_Unmarshalling c1 = new RestClient_Unmarshalling(hostname,
		// port_auth);
		//
		// try {
		// c1.makeGetRequest("/");
		...
		// // real requests
		//
		// // todo c1.makePostRequest("This is a client super complex message to
		// send to server");
		// } catch (Exception e) {
		...
		//
		//
		// RestClient_Unmarshalling c2 = new RestClient_Unmarshalling(hostname,
		// port_pay);
		//
		// try {
		// c2.makeGetRequest("/");
		...
		//
		// // todo c2.makePostRequest("This is a client super complex message to
		// send to server");
		// } catch (Exception e) {
		// System.out.println("Catched exception: " + e.getMessage());
		// }
		//
		// RestClient_Unmarshalling c3 = new RestClient_Unmarshalling(hostname,
		// port_airlines);
		//
		// try {
		// c3.makeGetRequest("/");
